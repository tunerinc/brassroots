...
describe('log out synchronous action creators', () => {
  it('creates log out request action', () => {
    ...
    expect(actions.logOutRequest()).toStrictEqual(expectedAction);
  });
  ...
  it('creates log out success action', () => {
    ...
    expect(actions.logOutSuccess()).toStrictEqual(expectedAction);
  });
  ...
  it('creates log out failure action', () => {
    ...
    expect(actions.logOutFailure(error)).toStrictEqual(expectedAction);
  });
});