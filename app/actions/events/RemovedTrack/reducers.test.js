...
describe('removed track reducer', () => {
  it('should return initial state', () => {
    expect(reducer(undefined, {})).toStrictEqual(initialState);
  });

  it('should handle REMOVED_TRACK', () => {
    const event: Event = {
    ...
    expect(reducer(initialState, actions.removedTrack())).toStrictEqual(initialState);

    expect(reducer(initialState, actions.removedTrack(event)))
      .toStrictEqual(
        {
          ...initialState,
          batch: [
